...
print('List: ' + str(first_list))
print('First element: ' + str(first_list[0]))
print('Last element: ' + str(first_list[-1]))
print('First 4 elements: ' + str(first_list[:4]))

new_first_list = first_list[-3:]
print('New list with last 3 elements of original list: ' + str(new_first_list))
...
print('Second list with 2,1,3 added: ' + str(second_list))
second_list.append('cyber')
print('Second list with cyber added: ' + str(second_list))
print('Index of cyber: ' + str(second_list.index('cyber')))
...
print('Full security log with 8.8.8.8 added: ' + str(security_log))
print('Entries in log: ' + str(len(security_log)))
print('5 latest IPs to access: ' + str(security_log[-5:]))
print('Times 3.100.186.196 appears: ' + str(security_log.count('3.100.186.196')))
